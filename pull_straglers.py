...
import csv, os, re, urllib2, urllib, requests, cookielib, mechanize, robotparser, time, random, string, sys, sqlite3, time, isfile()
...
while open('straglers.txt') as unpicked:
